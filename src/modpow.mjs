 ...
 * as this tries to mirror the original JSBN big number library from amazon-cognito-client-js, 
 * which seems to handle negative exponents as large positive exponents, 
 * we're leaving this unsupported for now.
 *
